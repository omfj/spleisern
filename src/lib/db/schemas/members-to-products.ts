...
export const membersToProducts = sqliteTable(
	...
	(t) => [primaryKey({ columns: [t.memberId, t.productId] })]
);

export const membersToProductsRelations = relations(membersToProducts, ({ one }) => ({
	member: one(members, {
...
export type MembersToProductsInsert = InferInsertModel<typeof membersToProducts>;
